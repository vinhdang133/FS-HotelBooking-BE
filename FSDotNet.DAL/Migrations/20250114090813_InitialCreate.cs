        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Users_CreateByUser",
                        column: x => x.CreateByUser,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Users_Users_UpdateByUser",
                        column: x => x.UpdateByUser,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Deposition = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_CreateByUser",
                table: "Users",
                column: "CreateByUser");

            migrationBuilder.CreateIndex(
                name: "IX_Users_UpdateByUser",
                table: "Users",
                column: "UpdateByUser");
        }
